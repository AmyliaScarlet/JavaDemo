...
public class RedisUtil { private JedisPool pool = null;

    private RedisUtil() {
        if (pool == null) {
            pool=new JedisPool();
//            String ip = JedisPoolConfigUtil.getIp();
////            int port = JedisPoolConfigUtil.getPort();
////            String password = JedisPoolConfigUtil.getPassword();
////
////            JedisPoolConfigUtil jedisPoolConfig = new JedisPoolConfigUtil();
////            jedisPoolConfig.setMaxActive(JedisPoolConfigUtil.getMaxActive());
////            jedisPoolConfig.setMaxIdle(JedisPoolConfigUtil.getMaxIdle());
////            jedisPoolConfig.setMaxWait(JedisPoolConfigUtil.getMaxWait());
////            jedisPoolConfig.setTestOnBorrow(JedisPoolConfigUtil.getTestOnBorrow());
////
////            if (password != null && !"".equals(password)) {
////                pool = new JedisPool(null, ip, port, 10000, password);
////            } else {
